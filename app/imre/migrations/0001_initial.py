    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_envio', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=True)),
                ('chat_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='imre.tecnicos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sla', models.IntegerField()),
                ('status', models.BooleanField(default=True)),
                ('id_tipo_os', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='imre.tiposos')),
            ],
            options={
