...
class Cancelar():
    ...
    #     try:
    #         self.browser.click(
    #             '//*[@title="Marque esta opção, para que seja aberta uma O.S. \
    #                 de retirada de equipamentos para este cliente."]'
    #         )
    #     except Exception as e:
    #         self.message_error(
    ...
    #     try:
    #         self.browser.click(
    #             '//div[@title="Informa qual o tipo da Ordem de Serviço."\
    #                 ]/div/button'
    #         )
    #         self.browser.write(
    #             '//input[@id="lookupSearchQuery"]',
    ...
    #     try:
    #         self.browser.click(
    #             '//div[@class="HTMLTabContainer"\
    #                 ]/div[5]/div[7]/div[2]/div/button'
    #         )
    #         self.browser.write(
    #             '//input[@id="lookupSearchQuery"]',
    ...
    #     try:
    #         self.browser.click(
    #             '//div[@title="Neste campo é informado o defeito associado a \
    #                 esta Ordem de Serviço."]/div/button'
    #         )
    #         self.browser.write(
    #             '//input[@id="lookupSearchQuery"]',
    ...
    #     try:
    #         self.browser.click(
    #             '//div[@class="HTMLTabContainer"]/div[6]/div[17]/input\
    #                 [@type="checkbox"]'
    #         )
    #     except Exception as e:
    #         self.message_error(
    ...
    #     except Exception as e:
    #         self.message_error(f"Error clique editar contrato: {e}")
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error clique contas associadas: {e}")
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error clique inserir nova conta: {e}")

    #     # criar multa
    #     try:
    #         self.browser.iframeFormRes()
    #     except Exception as e:
    #         self.message_error(f"Error criar multa: {e}")
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error descricao da multa: {e}")
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error valor da multa: {e}")
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error vencimento da multa: {e}")

    #     # quantidade de parcelas
    #     try:
    #         self.browser.write('//*[@title="Número de parcela"]', 1)
    #     except Exception as e:
    #         self.message_error(f"Error quantidade de parcelas: {e}")

    #     # plano de contas
    #     try:
    #         id_plano_de_contas = self.conexao.planos_de_contas.split()[0]
    #         self.browser.click(
    #             '//*[@title="Unidade de plano de contas referenciada para o \
    #                 lançamento"]/div/button'
    #         )
    #         self.browser.write(
    #             '//input[@id="lookupSearchQuery"]',
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error plano de contas: {e}")

    #     # próxima etapa da multa
    #     try:
    #         self.browser.click('//*[@title="Próxima etapa."]')
    #     except Exception as e:
    #         self.message_error(f"Error próxima etapa da multa: {e}")

    #     # faturar ?
    #     try:
    #         self.browser.click(
    #             '//div[@title="Deseja faturar agora estas contas?\nMarcando \
    #                 SIM, será criada uma fatura 1/1 para cada conta inserida."\
    #                     ]/div/button'
    #         )
    #         self.browser.click('//option[@value="S"]')
    #     except Exception as e:
    #         self.message_error(f"Error faturar ?: {e}")
    ...
    #     except Exception as e:
    #         self.message_error(f"Error qual profile usar: {e}")

    #     # marca check box
    #     try:
    #         self.browser.click(
    #             '//input[@title="Marque essa opção para confirmar seu desejo \
    #                 de inserir a nova conta."]'
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error marca check box: {e}")
    ...
    #         )
    #     except Exception as e:
    #         self.message_error(f"Error concluir multa: {e}")
