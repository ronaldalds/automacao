...
class Cancelar():
    ...
    def instancia(self) -> Mk:
        print(f"Iniciou Doc.: {self.conexao.documento_codigo}")
        try:
            ...
            self.message_error(f"Error instância: {e}")
    ...
    def cancelar(self) -> None:
        ...
        #         mk=self.conexao.mk
        #     ).id_web
        #     id_motivo_de_cancelamento = MotivoCancelamento.objects.get(
        #         descricao=self.conexao.motivo_cancelamento,
        #         mk=self.conexao.mk
        #     ).id_web
        #     id_grupo_atendimento_os = GrupoAtendimento.objects.get(
        #         descricao=self.conexao.grupo_atendimento_os,
        #         mk=self.conexao.mk
        #     ).id_web
        #     id_defeito = Defeito.objects.get(
        ...
        #     print(id_grupo_atendimento_os)
        #     print(id_defeito)

        # except Exception as e:
        #     self.message_error(f"Error: {e}")
        ...
        try:
            ...
            self.browser.close()
            self.message_error(f"Error clique moeda financeiro: {e}")
        ...
        try:
            ...
            self.browser.close()
            self.message_error(f"Error clique aside Painel do cliente: {e}")

        # clique pesquisa avançada
        try:
            self.browser.iframePainel(self.financeiro, self.painel_do_cliente)
            self.browser.click('//*[@title="Clique para fazer uma pesquisa \
                avançada de clientes ou fornecedores"]')
        except Exception as e:
            self.browser.close()
            self.message_error(f"Error clique pesquisa avançada: {e}")
        ...
        try:
            ...
            self.browser.close()
            self.message_error(f"Error Código de cadastro: {e}")
        ...
        try:
            ...
            self.browser.close()
            self.message_error(f"Error resultado de pesquisa avançada: {e}")
        ...
        # if "S" in conexao.incidencia_de_multa.upper():
        #     set_multa(conexao, browser)

        # # clique no resultado do click duplo no cadastro do cliente
        # try:
        #     browser.iframeGridRes(financeiro, painel_do_cliente)
        #     browser.click(f'//div[text()={conexao.contrato}]')
        # except Exception as e:
        #     browser.close()
        #     message_error(
        #         conexao,
        ...
        #     browser.write(
        #         '//input[@id="lookupSearchQuery"]',
        #         conexao.motivo_cancelamento.split()[0] + Keys.ENTER
        #     )
        #     browser.click(f'//option[@value="{id_motivo_de_cancelamento}"]')
        # except Exception as e:
        #     browser.close()
        #     message_error(
        #         conexao,
        ...
        #     browser.write(
        #         '//input[@id="lookupSearchQuery"]',
        #         conexao.tipo_os.split()[0] + Keys.ENTER
        #     )
        ...
        #     browser.write(
        #         '//input[@id="lookupSearchQuery"]',
        #         conexao.grupo_atendimento_os + Keys.ENTER
        #     )
        #     browser.click(f'//option[@value="{id_grupo_atendimento_os}"]')
        # except Exception as e:
        #     browser.close()
        #     return message_error(
        ...
        #     browser.write(
        #         '//input[@id="lookupSearchQuery"]',
        #         conexao.defeito + Keys.ENTER
        #     )
        #     browser.click(f'//option[@value="{id_defeito}"]')
        # except Exception as e:
        #     browser.close()
        #     return message_error(
        #         f"Error Defeito: {e}"
        ...
        # try:
        #     browser.click('//div[@class="HTMLTabContainer"]/div[6]/div[17]/input[@type="checkbox"]')
        # except Exception as e:
        #     browser.close()
        #     return message_error(
...
# def set_multa(conexao: Cancelamento, browser: Mk) -> None:
#     financeiro = Financeiro()
#     painel_do_cliente = PainelDoCliente()
#     try:
#         id_profile = Profile.objects.get(
#             descricao=conexao.profile,
#             mk=conexao.mk
#         ).id_web
#         print(id_profile)
#     except Exception as e:
#         return message_error(f"Error: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error clique editar contrato: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error clique contas associadas: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error clique inserir nova conta: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error criar multa: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error descricao da multa: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error valor da multa: {e}")

#     # vencimento da multa
#     try:
#         browser.write(
#             '//*[@title="Data de vencimento da conta."]',
#             conexao.data_vcto_multa_contratual
#         )
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error vencimento da multa: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error quantidade de parcelas: {e}")

#     # plano de contas
#     try:
#         id_plano_de_contas = conexao.planos_de_contas.split()[0]
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error plano de contas: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error próxima etapa da multa: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error faturar ?: {e}")
...
#         browser.write(
#             '//input[@id="lookupSearchQuery"]',
#             f"{conexao.profile.split()[0]}" + Keys.ENTER)
#         browser.click(f'//option[@value="{id_profile}"]')
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error qual profile usar: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error marca check box: {e}")
...
#     except Exception as e:
#         browser.close()
#         return message_error(f"Error concluir multa: {e}")
